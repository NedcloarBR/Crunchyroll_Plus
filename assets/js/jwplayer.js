window.jwplayer = (function (t) {
  ...
  function (t, e, n) {
    ...
    function y() {
      return (
        (i(/safari/i) && !i(/(?:Chrome|CriOS|chromium|android|phantom)/i)) ||
        g()
      );
    }
    function j() {
    ...
    function x() {
      ...
      var t,
        e = navigator.plugins;
      if (e && (t = e.namedItem("Shockwave Flash")) && t.description)
    ...
    var r = (function () {
        ...
        return (
          ...
          (e.off = function (t, e, n) {
            ...
            for (
              var r = t ? [t] : Object.keys(this._events), i = 0, o = r.length;
              i < o;
              i++
            ) {
              t = r[i];
              ...
              if (u) {
                ...
                if (e || n)
                  for (var c = 0, s = u.length; c < s; c++) {
                    var f = u[c];
                    ((e && e !== f.callback && e !== f.callback._callback) ||
                      (n && n !== f.context)) &&
                      a.push(f);
                  }
            ...
            var e,
              ...
              p = (function (t, e) {
                ...
                if (Array.isArray(n) && n.length)
                  for (
                    var u = Object(i.f)(t.get("item"), n.length),
                      a = Object(i.c)(Object(r.a)(n[u]), t),
                      c = 0;
                    c < a.length;
                    c++
                  )
                    for (
                      var s = a[c], l = t.getProviders(), f = 0;
                      f < o.a.length;
                      f++
                    ) {
                      var d = o.a[f];
  ...
  function (t, e, n) {
    ...
    function o(t, e) {
      if (
        ((e && Object(r.exists)(e)) || (e = document.location.href),
        !Object(r.exists)(t))
      )
        return "";
      if (u(t)) return t;
    ...
    function l(t, e) {
      if (
        (Object(i.u)(t) && (t = parseInt(t.toString())),
  ...
  function (t, e, n) {
    ...
    var r = n(31),
      ...
      u = function () {
        return (
          (Object(i.isFileProtocol)() ? "https:" : "") +
          "//ssl.p.jwpcdn.com/player/v/8.15.1/"
        );
      },
      a = function (t) {
        var e = ("0" + t).split(/\W/),
      ...
      return (i || r)
        .map(function (e) {
          ...
          b(e, n, "androidhls"),
            ...
            (function (t, e, n) {
              t.liveSyncDuration ||
                b(t, e.liveSyncDuration ? e : n, "liveSyncDuration");
            })(e, t, n),
                  ...
                  .map(function (u) {
                    ...
                    return e
                      ...
                      .catch(function (t) {
                        return (
                          e.removePlugin(u),
                          t.code ? t : new r.s(null, Object(i.b)(u), t)
                        );
                      });
                  })
              )
  ...
  function (t, e, n) {
    ...
    function f(t, e, n) {
      ...
      if (
        ...
        return (
          t.responseXML || (t = Object(r.j)({}, t, { responseXML: e })),
          n.oncomplete(t)
        );
      l(n, u.o, 601);
    }
          ...
          a = function (r) {
            if (
              ...
              if (!t.directSelect || i === e) {
                ...
                if (
                  ((t.dragged = !1),
                  (t.lastStart = Object(c.a)()),
                  (t.startX = f),
                  (t.startY = d),
                  O(t, "window"),
                  "pointerdown" === u && r.isPrimary)
                ) {
                  if (!n) {
                    var p = r.pointerId;
                    (t.pointerId = p), e.setPointerCapture(p);
                  }
                  w(t, "window", "pointermove", l, o),
                    w(t, "window", "pointercancel", h),
                    w(t, "window", "pointerup", h),
                    "BUTTON" === e.tagName && e.focus();
                } else
                  "mousedown" === u
                    ? (w(t, "window", "mousemove", l, o),
                      w(t, "window", "mouseup", h))
                    : "touchstart" === u &&
                      (w(t, "window", "touchmove", l, o),
          ...
          l = function (e) {
            if (t.dragged) x(t, u.s, e);
              ...
              var r = P(e),
                ...
                c = o - t.startY;
              a * a + c * c > 36 &&
                (x(t, u.u, e), (t.dragged = !0), x(t, u.s, e));
            }
            n || "touchmove" !== e.type || S(e);
          },
          h = function (n) {
            if ((clearTimeout(r), t.el))
              if ((k(t), O(t, "window"), t.dragged))
                (t.dragged = !1), x(t, u.t, n);
              else if (
                ...
                !(function (t, e, n) {
                  ...
                  o
                    ? x(t, u.n, n)
                    : (x(t, u.sb, n), "touchend" !== n.type || p || S(n));
              }
          };
        f
          ? w(t, "init", "pointerdown", a, o)
          : (d && w(t, "init", "mousedown", a, o),
            w(t, "init", "touchstart", a, o)),
          i || (i = new v(document).on("interaction")),
          w(t, "init", "blur", function () {
            Object(s.o)(e, "jw-tab-focus");
          }),
          w(t, "init", "focus", function () {
            i.event &&
              "keydown" === i.event.type &&
              Object(s.a)(e, "jw-tab-focus");
          });
      }
    }
    var y = {
      ...
      over: function (t) {
        (f || d) &&
          w(t, u.Z, f ? "pointerover" : "mouseover", function (e) {
      ...
      out: function (t) {
        if (f) {
          ...
          d &&
            w(t, u.Y, "mouseout", function (e) {
              x(t, u.Y, e);
            });
      },
      move: function (t) {
        (f || d) &&
          w(t, u.W, f ? "pointermove" : "mousemove", function (e) {
        ...
        for (var a = [], c = 0; c < Object(r.c)(e); c++) {
          ...
          if ("media" === s.prefix) {
            ...
            switch (Object(r.b)(s).toLowerCase()) {
              case "content":
                if (
                  (Object(i.j)(s, "duration") &&
                    (n.duration = Object(i.g)(Object(i.j)(s, "duration"))),
                  Object(i.j)(s, "url"))
                ) {
                  n.sources || (n.sources = []);
                  var l = {
              ...
              case "subtitle":
                ...
                Object(i.j)(s, "lang").length > 0 &&
                  (d.label = o(Object(i.j)(s, "lang"))),
                  a.push(d);
            }
          }
        }
        ...
        for (
          ...
          if ("jwplayer" === s.prefix) {
            ...
            "source" === l
              ...
              : ((e[l] = Object(c.serialize)(Object(r.d)(s))),
        ...
        if (u.length) {
          ...
          for (var p = 0; p < u.length; p++) {
            ...
            h.file &&
              h.file.length > 0 &&
              ((h[n] = "true" === u[p][n]),
              (h.kind = u[p].kind.length ? u[p].kind : "captions"),
              h.label || delete h.label,
              e.tracks.push(h));
          }
        }
        return e;
  ...
  function (t, e, n) {
    ...
    e.b = function (t, e) {
      ...
      var O = v.liveTimeout;
      null !== O &&
        (Object(r.z)(O) ? 0 !== O && (O = Math.max(30, O)) : (O = null),
        (v.liveTimeout = O));
      var k,
        C,
      ...
      return (
        (v.bandwidthEstimate = Object(r.z)(x)
          ? x
          : ((k = v.defaultBandwidthEstimate),
            (C = parseFloat(k)),
        ...
        (v.backgroundLoading = Object(r.r)(v.backgroundLoading)
          ? v.backgroundLoading
      ...
      Object(r.j)(l.prototype, {
        ...
        getNewInstance: function (t, e, n) {
          ...
          if ("function" != typeof r)
            throw new a.s(null, Object(c.b)(this.url) + 100);
          var i = new r(t, e, n);
          return (
      ...
      function e(e) {
        try {
          ...
          if (c) {
            ...
            if (
              (l && "xml" === Object(o.b)(l) && (l = l.nextSibling),
              l && "rss" === Object(o.b)(l))
            ) {
              var d = Object(u.a)(l);
  ...
  function (t, e, n) {
    ...
    function g(t, e) {
      var n = "file:" === window.location.protocol ? "https:" : "",
        r = {
          bidding:
            "//ssl.p.jwpcdn.com/player/plugins/bidding/v/0.3.10/bidding.js",
          ...
          googima: e
            ? "//ssl.p.jwpcdn.com/player/v/8.15.1/googimanvmp.js"
            : "//ssl.p.jwpcdn.com/player/plugins/googima/v/8.7.17/googima.js",
          freewheel:
            "//ssl.p.jwpcdn.com/player/plugins/freewheel/v/2.2.11/freewheel.js",
          ...
          Object(r.x)(i) &&
            ...
            ((y.playlist = (function (t, e) {
              var n = (t.querySelector("title") || {}).textContent,
                ...
                o =
                  l(t, 'meta[property="og:description"]') ||
                  l(t, 'meta[name="description"]');
              return (
    ...
    function F(t) {
      return L(t)
        ...
        : S(t)
            .then(function () {
              if (t.get("drm") || Object(A.b)(t.get("playlist")))
                return Object(A.d)(t.get("edition"));
            })
            .then(function () {
    ...
    var N = function (t) {
        ...
        return "string" != typeof e ||
          ...
          ? Promise.resolve()
          : new C.a(e, !0).load().catch(function (t) {
              return t;
            });
      },
      R = function (t) {
      ...
      getAllItems: function () {
        ...
        return this.items.reduce(function (e, n) {
          ...
          return (
            r &&
              (e[n] =
                "captions" !== n ? Object(q.serialize)(r) : JSON.parse(r)),
            e
          );
        }, {});
      },
    ...
    function tt(t, e) {
      e &&
        ...
        console.error(x.s.logMessage(e.code)));
    }
    function et(t) {
    ...
    Object(r.j)(G.prototype, {
      ...
      init: function (t, e) {
        ...
        i.get("backgroundLoading") ||
          (s = Object(Z.a)(s.getPrimedElement(), s));
        var l = new $.a(Object($.b)(this.originalContainer)).once(
          "gesture",
          function () {
                    ...
                    if (!o) {
                      ...
                      J.a.cloneIcon &&
                        u
                          ...
                          .appendChild(J.a.cloneIcon("error")),
                        nt(t, u);
                    }
                    i.set("errorEvent", r),
                      i.set("state", w.mb),
      ...
      playerDestroy: function () {
        this.apiQueue && this.apiQueue.destroy(),
          ...
          this.currentContainer !== this.originalContainer &&
            nt(this, this.originalContainer),
          this.off(),
  ...
  function (t, e, n) {
    ...
    Object(r.j)(F.prototype, {
      ...
      trigger: function (t, e) {
        return (
          ((e = r.f.isObject(e) ? Object(r.j)({}, e) : {}).type = t),
      ...
      if (
        (t
          ? "string" == typeof t
            ...
            ? (e = v.a[t])
            : t.nodeType &&
              (e = M((n = t).id || n.getAttribute("data-jwplayer-id")))
          : (e = v.a[0]),
        e)
      )
        return e;
